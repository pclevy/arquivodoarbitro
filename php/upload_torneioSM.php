...
ini_set('display_errors', 1);
	...
	//$conexao=pg_connect("host=localhost port=5432 dbname=esfinge_arbitro user=esfinge_arbitro password=scly1411"); // or die("erro na conexão: ");
	$conexao=pg_connect($strconexao); // or die("erro na conexão: ");								// ***** 2026/03/09 *****
	
	if (!$conexao) {
    error_log("Erro ao conectar ao banco de dados: " . pg_last_error($conexao));				// ***** 2026/03/09 *****
